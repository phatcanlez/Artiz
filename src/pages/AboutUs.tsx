...
const AboutUs: React.FC = () => {
  const values = [
    { title: "Quality", desc: "Chất lượng là ưu tiên hàng đầu trong mọi sản phẩm chúng tôi tạo ra." },
    { title: "Innovation", desc: "Luôn tìm kiếm và áp dụng công nghệ mới nhất để cải thiện sản phẩm." },
    { title: "Customer Focus", desc: "Khách hàng là trung tâm của mọi quyết định và hoạt động của chúng tôi." },
    { title: "Sustainability", desc: "Cam kết sử dụng vật liệu thân thiện với môi trường và quy trình bền vững." },
  ];

  const whyUs = [
    { title: "Công nghệ hiện đại", desc: "Trang thiết bị in 3D tiên tiến, cho ra sản phẩm sắc nét và chính xác." },
    { title: "Đội ngũ chuyên nghiệp", desc: "Kỹ thuật viên giàu kinh nghiệm, sẵn sàng tư vấn và hỗ trợ 24/7." },
    { title: "Giao hàng nhanh", desc: "Quy trình tối ưu giúp rút ngắn thời gian sản xuất và giao hàng." },
    { title: "Giá cả hợp lý", desc: "Chính sách giá minh bạch, cạnh tranh, phù hợp mọi ngân sách." },
    { title: "Bảo hành uy tín", desc: "Cam kết đổi trả và bảo hành sản phẩm trong vòng 30 ngày." },
  ];
    ...
    <div className="flex flex-col min-h-screen bg-black text-white">
      ...
      <div className="text-center pt-12 pb-4 px-6">
        <h1
          ...
          style={{ fontFamily: SVN, fontSize: "clamp(48px, 10vw, 140px)", letterSpacing: "-0.02em" }}
        >
          About Us
        </h1>
      </div>
      ...
      <section className="py-14 px-6">
        <div className="relative flex flex-col items-center text-center py-4 mb-10">
          ...
          <h2 className="text-white uppercase text-2xl sm:text-3xl md:text-4xl" style={{ fontFamily: SVN }}>
            Our Story
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-4xl mx-auto">
          {[
            ...
            <div
              ...
              style={{ clipPath: clip }}
            >
              <p className="font-black text-2xl uppercase" style={{ fontFamily: ARIAL }}>{item.label}</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 max-w-4xl mx-auto">
          {values.map((item, i) => (
            <div
              ...
              style={{ clipPath: clip }}
            >
              <p className="font-black text-xl uppercase tracking-wide" style={{ fontFamily: ARIAL }}>{item.title}</p>
      ...
      <section className="py-14 px-6">
        ...
        <div className="max-w-4xl mx-auto bg-[#e8e8e8] text-black p-6 flex flex-col gap-4" style={{ clipPath: clip }}>
          <h3 className="font-black text-xl leading-snug" style={{ fontFamily: ARIAL }}>
            {"What Sets Us Apart"}
          </h3>
          {whyUs.map((item, i) => (
            <div key={i}>
      ...
      <section className="py-16 px-6 pb-20 text-center flex flex-col items-center gap-6">
        <h2
          className="text-white uppercase leading-none"
          style={{ fontFamily: SVN, fontSize: "clamp(32px, 6vw, 80px)" }}
        >
          Ready to Create?
        </h2>
        <p className="text-white/60 text-sm max-w-md leading-relaxed">
          Hãy liên hệ với chúng tôi để bắt đầu dự án in 3D của bạn — từ mẫu có sẵn đến thiết kế hoàn toàn riêng.
        </p>
        <a
          href="/contact"
